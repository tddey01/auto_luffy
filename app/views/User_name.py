...
from app.forms.users import UserModelForms,UpdateUserModelForms,ResetpassUserModelForms,
from rbac.services.Menu_urls import memory_cul,memory_resverse
...
def user_list(request):
    ...
    return render(request, 'user_list.html', {'users': user_queryse})
...
def user_add(request):
    ...
    if form.is_valid():
        form.save()
        return redirect(memory_resverse('user_list'))
    return render(request, 'rbac/change.html', {'form': form})
...
def user_edit(request, pk):
    ...
    if form.is_valid():
        form.save()
        return redirec(memory_resverse('user_list'))
    return render(request, 'rbac/change.html', {'form': form})
